  ...
  <div class="shop-header">
    ...
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <a class="back" @click="$router.back()">
        <i class="iconfont icon-fanhui icon-arrow_left"></i>
      </a>
    </nav>
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="showBulletin=true">
    ...
    <!--优惠活动-->
    <div class="shop-header-discounts" @click="showSupports=true" v-if="info.supports">
...
<script>
  ...
  export default {
    data(){
      return{
        showBulletin:false,//是否展示公告信息
        showSupports:false,//是否展示所有的优惠活动
